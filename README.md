...
1. Create the Azure DevOps variable group `email-gateway-production` containing `DATABASE_URL`, `REDIS_URL`, `SES_RATE_LIMIT_PER_MINUTE`, and `GATEWAY_API_KEY` (all marked secret).
